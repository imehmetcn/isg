        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <Link 
                href="/demo"
                className="bg-purple-600 text-white px-8 py-4 rounded-lg hover:bg-purple-700 transition flex items-center gap-2"
              >
                Demo İncele
              ...
              <Link
                href="/contact"
                className="bg-white text-purple-600 border-2 border-purple-600 px-8 py-4 rounded-lg hover:bg-purple-50 transition"
              >
                İletişime Geçin
              </Link>
            </motion.div>
